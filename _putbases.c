#include "holberton.h"
/**
 * _putbin - print binary representation of number
 * @num: input integer
...
/**
 * _puthex - print lowercase hex representation of a number
 * @num: input integer
 * @format: the format to use to prepare the string
...
/**
 * _putHex - print uppercase hex representation of a number
 * @num: input integer
 * @format: the format to use to prepare the string
 * Return: length of hex
 */
...
/**
 * _putoct - print octal representation of a number
 * @num: input integer
 * @format: the format to use to prepare the string
